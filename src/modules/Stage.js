...
const HUD_LOCATIONS = {
    ...
    FULL_SCREEN_LINK: new Point(MAX_X - 11, MAX_Y - 10),
    PAUSE_LINK: new Point(MAX_X - 185, MAX_Y - 10),
    MUTE_LINK: new Point(MAX_X - 110, MAX_Y - 10),
...
class Stage extends Container {
    ...
    _setStage() {
        ...
        const tree = new extras.AnimatedSprite([
